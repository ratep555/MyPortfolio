...
namespace Infrastructure.Services
{
    public class SegmentService : ISegmentService
    {
        ...
        public async Task<List<Segment>> GetSegmentsWithSearchingAndPaging(QueryParameters queryParameters)
        {
            ...
            return await segment.ToListAsync();   
        }

        public async Task<int> GetCountForSegments()
        {
